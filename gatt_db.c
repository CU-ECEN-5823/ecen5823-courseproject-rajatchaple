...
uint8_t bg_gattdb_data_attribute_field_14_data[13]={0x52,0x61,0x6a,0x61,0x74,0x27,0x73,0x20,0x47,0x65,0x63,0x6b,0x6f,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x000c,.permissions=0x803,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x02,.index=0x06,.clientconfig_index=0x02}},
    ...
    {.uuid=0x000c,.permissions=0x803,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x09,.clientconfig_index=0x04}},
